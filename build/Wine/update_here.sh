...
cp -u $HOME/bin/Yatube/resources/icon_64x64_yatube.ico ./resources/

# (Wine-only) Copy build scripts
cp -u $HOME/bin/Yatube/build/Wine/{build.sh,clean_up.sh,setup.py,update_yatube.sh,Yatube.cmd} .
